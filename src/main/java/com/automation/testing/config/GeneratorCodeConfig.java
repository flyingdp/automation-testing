...
public class GeneratorCodeConfig {
    ...
    private static String mysql_url = "112.124.57.111";
    private static String mysql_account = "root";
    private static String mysql_password = "123456";
    private static String database = "automation-testing";
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://" + mysql_url + ":33060/" + database+"?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&useSSL=false&allowPublicKeyRetrieval=true");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername(mysql_account);
        dsc.setPassword(mysql_password);
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.automation.testing");
        pc.setEntity("entity");
        pc.setMapper("mapper");
